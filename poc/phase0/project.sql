...
-- @PROJECT@ and @PASSWORD@ are replaced only with locally generated safe values.
CREATE ROLE @PROJECT@_auth LOGIN PASSWORD '@PASSWORD@';
CREATE ROLE @PROJECT@_rest LOGIN NOINHERIT PASSWORD '@PASSWORD@';
CREATE ROLE @PROJECT@_storage LOGIN NOINHERIT BYPASSRLS PASSWORD '@PASSWORD@';
CREATE ROLE @PROJECT@_realtime LOGIN NOINHERIT REPLICATION BYPASSRLS PASSWORD '@PASSWORD@';
CREATE ROLE @PROJECT@_owner LOGIN PASSWORD '@PASSWORD@';
